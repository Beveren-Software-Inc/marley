...
export const InternalTransferList = ({ patient, refreshKey }: InternalTransferListProps) => {
      ...
      <table className="w-full text-sm border-collapse">
        ...
        <tbody>
          {loading ? (
            ...
            <tr>
              <td colSpan={7} className="px-3 py-8 text-center text-slate-400 text-xs">No internal transfers found</td>
            </tr>
          ) : (
            rows.map((row) => (
