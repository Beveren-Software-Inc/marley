...
import { updateAppointmentAdRemark, type Appointment } from '../../services/appointments'
import { toast } from '../../hooks/useToast'

interface AppointmentAdRemarkModalProps {
  appointment: Appointment
  onClose: () => void
  onSuccess: () => void
}

export const AppointmentAdRemarkModal = ({
  appointment,
  onClose,
  onSuccess,
}: AppointmentAdRemarkModalProps) => {
  const [remark, setRemark] = useState(appointment.remarks || '')
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-4">
          <div>
            ...
            <textarea
              ...
              rows={4}
              placeholder="Add administrative / reception notes for this appointment…"
