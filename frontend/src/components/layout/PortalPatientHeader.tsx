    ...
    <>
      ...
      <header className="hidden md:flex items-center gap-3 bg-primary text-white px-4 py-3 border-b border-white/20 shrink-0">
        <div className="flex-1 min-w-0">
          <PatientSearch selectedPatient={selectedPatient} onPatientSelect={onPatientSelect} patients={patients} showAlertsBanner={showAlertsBanner} />
        </div>
