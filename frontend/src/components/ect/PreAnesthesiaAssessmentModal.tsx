      ...
      <div className="relative z-10 w-full max-w-3xl max-h-[92vh] bg-white rounded-xl shadow-2xl flex flex-col overflow-hidden"
        ...
        <div className="mx-6 mt-4 rounded-lg border border-primary/20 bg-primary/5 px-4 py-3">
          ...
          <p className="text-xs text-slate-600">
            {isIPMode 
              ? `The pre-anesthesia assessment will be linked to the selected inpatient admission. Make sure you have an admission selected below.`
              : isOPMode
              ? `The pre-anesthesia assessment will be linked to the selected outpatient visit. Make sure you have a visit selected below.`
